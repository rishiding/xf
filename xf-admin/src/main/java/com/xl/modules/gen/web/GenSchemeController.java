 ...
 */
package com.xl.modules.gen.web;
...
import com.xl.modules.gen.service.GenSchemeService;
import com.xl.modules.gen.service.GenTableService;
import com.xl.modules.gen.util.GenUtils;
...
public class GenSchemeController extends BaseController {
	...
	public String form(GenScheme genScheme, Model model) {
		if (StringUtils.isBlank(genScheme.getPackageName())){
			genScheme.setPackageName("com.xl.modules");
		}
...
//		}
	...
	public String save(GenScheme genScheme, Model model, RedirectAttributes redirectAttributes) {
		...
		logger.debug(result);
		addMessage(redirectAttributes, "操作生成方案'" + genScheme.getName() + "'成功<br/>");
