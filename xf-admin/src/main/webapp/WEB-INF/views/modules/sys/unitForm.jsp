...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/sys/unit/">单位管理列表</a></li>
		<li class="active"><a href="${ctx}/sys/unit/form?id=${unit.id}">单位管理<shiro:hasPermission name="sys:unit:edit">${not empty unit.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="sys:unit:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="unit" action="${ctx}/sys/unit/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				<sys:treeselect id="area" name="area.id" value="${unit.area.id}" labelName="area.name" labelValue="${unit.area.name}"
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="usable" htmlEscape="false" maxlength="64" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="control-group">
			...
			<div class="controls">
				<sys:treeselect id="office" name="office.id" value="${unit.office.id}" labelName="office.name" labelValue="${unit.office.name}"
		...
		<div class="form-actions">
			<shiro:hasPermission name="sys:unit:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
